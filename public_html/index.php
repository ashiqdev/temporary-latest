...
<html lang="en">
  <head>
    ...
    />
    <meta name="description" content="Create disposable and temporary email addresses in an instant without the hassle of receiving spam or needing to sign up." />
...
<link rel="manifest" href="/assets/images/favicon_io/site.webmanifest" crossorigin="use-credentials">
    ...
    <title>TemporaryMail.com - Disposable Email Service</title>
  ...
  <!--=========================-->
   ...
   ?>
    ...
    <div class="app-content content" style="">
      <!-- BEGIN ***INDEX-SECTION*** -->
      <section class="index easy_setup_area sec_pad">
        <div class="content-wrapper" style="text-align: center" ;>
          ...
          <div class="company-desc col-lg-8 mx-auto ">
            <p class="mx-auto col-lg-12" style="line-height: 1.8;">
                      ...
                      <div class="contact-infos">
                        ...
                        <div class="contact-info">
                          ...
                          <div class="info">
                            ...
                            <span><a href="mailto:support@temporarymail.com">support@temporarymail.com</a></span>
                          </div>
                        </div>
                        <!-- /.contact-info -->
                      </div>
              ...
              <section class="wow fadeInLeft">
                <div>
                  <div style="text-align: center">
                    <h3 style="font-size: 40px" class="bold">Blog</h3>
                    <p class="f_size_17">
                        ...
                        <div class="blog_list_item mb_50">
                          ...
                          <div class="blog_content">
                            ...
                            <div class="entry_post_info">
                              ...
                              <a class="home-btn">Temporary Mail</a>
                            </div>
                  ...
                  <div class="blog_single mb_50">
                    ...
                    >
                      ...
                      <div class="entry_post_info">
                        ...
                        <a class="home-btn">TemporaryMail</a>
                      </div>
                      
                        <h4 class="f_p f_size_30 f_500 t_color mb-30">
                          One Year Active 
                        </h4>
                    ...
                    >
                      ...
                      <div class="new_service_content">
                        <img
                          ...
                          alt=""
                        />
                        <h4 class="f_size_24 f_p t_color f_500">Anonymous</h4>
                        <p class="f_400 f_size_17 mb-0">
                    ...
                    >
                      ...
                      <div class="new_service_content">
                        <img
                          ...
                          alt=""
                        />
                        <h4 class="f_size_24 f_p t_color f_500">Free</h4>
                        <p class="f_400 f_size_17 mb-0">
                    ...
                    >
                      ...
                      <div class="new_service_content">
                        <img
                          ...
                          alt=""
                        />
                        <h4 class="f_size_24 f_p t_color f_500">
                          Extreme Security
                        </h4>
                        <p class="f_400 f_size_17 mb-0">
          ...
          <section class="easy_setup_area" style="padding-bottom: 2.2rem">
            <div class="container font-f">
              <div class="hosting_title analytices_title text-center" style="">
                <h2>
                  <span class="ana-title bold" style="font-weight: bold;">Frequently Asked Question</span>
                </h2>
          ...
          >
            <div class="container">
              ...
              <div style="text-align: center" class="wow fadeInLeft">
                <h3 class="bold" style="font-size: 40px">Privacy Policy</h3>
                <p
                  style="font-size: 17px; line-height: 1.8; margin-bottom: 30px"
                >
                ...
                <!-- 1 -->
                <div class="text-left">
                  <h3 style="font-size: 25px" class="divider gradient">Privacy policy</h3>
                  <p class="description f_size_17">
                ...
                <!-- 2 -->
                <div class="text-left">
                  <h3 style="font-size: 25px" class="divider gradient">
                ...
                <!-- 3 -->
                <div class="text-left">
                  <h3 style="font-size: 25px" class="divider gradient">Log Data</h3>
                  <p class="description f_size_17">
                ...
                <!-- 4 -->
                <div class="text-left">
                  <h3 style="font-size: 25px" class="divider gradient">Cookies</h3>
                  <p class="description f_size_17">
                ...
                <!-- 5 -->
                <div class="text-left">
                  <h3 class="divider gradient" style="font-size: 25px">Service Providers</h3>
                  <p class="description f_size_17">
                    We may employ third-party companies and individuals due to
                    the following reasons:
                  </p>

                  <ul class="description f_size_17">
                ...
                <!-- 6 -->
                <div class="text-left">
                  <h3 class="divider gradient" style="font-size: 25px">Security</h3>
                  <p class="description f_size_17">
                ...
                <!-- 7 -->
                <div class="text-left">
                  <h3 class="divider gradient" style="font-size: 25px">Links to Other Sites</h3>
                  <p class="description f_size_17">
                ...
                <!-- 8 -->
                <div class="text-left">
                  <h3 class="divider gradient" style="font-size: 25px">Children’s Privacy</h3>
                  <p class="description f_size_17">
                ...
                <!-- 9 -->
                <div class="text-left">
                  <h3 class="divider gradient" style="font-size: 25px">
                  ...
                  <p class="description f_size_17">Contact Us</p>

                  <p class="description f_size_17">
                    If you have any questions or suggestions about our Privacy
                    Policy, do not hesitate to contact us at
                    <a href="mailto:Team@TemporaryMail.com">Team@TemporaryMail.com.</a>
          ...
          <section class="condition-section">
            <div class="content-wrapper" style="text-align: center">
              ...
              >
                <div class="container">
                  <div style="text-align: center">
                    <h3 class="bold" style="font-size: 40px">Terms of Service</h3>
                    <p
                      style="
                        font-size: 17px;
                        line-height: 1.8;
          ...
          >
            <div class="wow fadeInDown">
              <div class="section-title style-four text-center">
                <h2 style="margin-bottom: 30px; font-weight: bold; font-size: 40px;" class="title wow pixFadeUp" data-wow-delay="0.3s">
                  Inbox
                </h2>
              ...
              <div class="our__emails">
                ...
                <div class="email__list">
                  <div class="mail-info">
                    ...
                    <div class="info">
                      <h4 class="email-title"><p>Nixon Smith</p></h4>
                      <p class="designation">
                          <span
                          style="vertical-align: middle;"
                          class="material-icons"
                ...
                <div class="email__list">
                  <div class="mail-info">
                    ...
                    <div class="info">
                      <h4 class="email-title"><p>The Home x</p></h4>
                      <p class="designation">
                          <span
                          style="vertical-align: middle;"
                          class="material-icons"
                ...
                <div class="email__list">
                  <div class="mail-info">
                    ...
                    <div class="info">
                      <h4 class="email-title"><p>Moove Agency</p></h4>
                      <p class="designation">
                          <span
                          style="vertical-align: middle;"
                          class="material-icons"
      ...
      <section class="single-email-section">
        <div class="content-wrapper">
          ...
          <!--=         Email Body       =-->
          <!--============================-->
          <section class="email-body wow fadeInLeft">
            <div class="action-content">
              <h3 style="font-weight: bold;">Email Subject</h3>
              <div class="button-group">
                <button class="css-button-neumorphic home-btn" id="myhomebtn">
                ...
                <div class="email-content-upper-part">
                  <div class="email-content-upper-left">
                    ...
                    <div style="margin-top: -6px;">
                      ...
                      <span style="font-size: 17px;">john@gmail.com</span>
                  ...
                  <div class="email-content-upper-right">
                    <p style="font-size: 15px; font-weight:bold">Jan 9, 2022, 6:34 PM (2 days ago)</p>
                  </div>
                </div>
              </div>
  
              <div class="email-body-content email-desc">
    ...
    <div id="cookiePopup" class="hide">
      ...
      <p>
        This website uses cookies to provide your browsing experience and
        relevant information. Before continuing to use our website, you agree
        and accept of our <a href="#">Cookie Policy</a>
      </p>

      <button id="acceptCookie" class="random-button btn btn-primary bg-gradient-x-blue" style="text-transform: uppercase;">Accept</button>
    </div>
