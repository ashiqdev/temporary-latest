...
(function(window, document, $) {
  ...
  $.app.menu = {
    ...
    manualScroller: {
      ...
      init: function() {
        var scroll_variable = ($('.main-menu').hasClass('menu-dark')) ? 'light' : 'dark';
        this.obj = $(".main-menu-content").perfectScrollbar({
          suppressScrollX: true,
          theme: scroll_variable
        });
      },
  ...
  $.app.nav = {
    ...
    adjustSubmenu: function ( $menuItem ) {
      ...
      bottomOffset, subMenuHeight, popOutMenuHeight, borderWidth, scroll_variable,
      ...
      scroll_variable     = ($('.main-menu').hasClass('menu-dark')) ? 'light' : 'dark';
